                                ...
                                <div>
                                    ...
                                    <Form.Group as={Row} controlId="Date" style={{ display: "flex", flexDirection: "row", alignItems: "center", marginBottom: "15px" }}>
                                        ...
                                        <Col xs={2} style={{ display: 'flex', alignItems: 'center' }}>
                                            <Form.Control type="text" name="Ref_Water_Table_Depth" defaultValue={this.props.inputValues.Ref_Water_Table_Depth} required onChange={this.props.handleChange} style={{ marginRight: '8px' }} />
                                    ...
                                    <Form.Group as={Row} controlId="Date" style={{ display: "flex", flexDirection: "row", alignItems: "center", }}>
                                        ...
                                        <Col xs={2} style={{ display: 'flex', alignItems: 'center' }}>
                                            <Form.Control type="text" name="Ref_Halfspace_Vs" defaultValue={this.props.inputValues.Ref_Halfspace_Vs} required onChange={this.props.handleChange} style={{ marginRight: '8px' }} />
                                        ...
                                        <Col xs={2} style={{ display: 'flex', alignItems: 'center' }}>
                                            <Form.Control type="text" name="Ref_Halfspace_Damping" defaultValue={this.props.inputValues.Ref_Halfspace_Damping} required onChange={this.props.handleChange} style={{ marginRight: '8px' }} />
