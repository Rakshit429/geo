...
import { runCsmipAnalyze, runCsmipGenerateFAS, runCsmipGenerateMotion } from "../../../lib/api";
...
class Application extends Component {
    ...
    Generate_FAS = () => {
        ...
        runCsmipGenerateFAS(this.state)
            .then(json => {
                console.log(json);
                this.setState({
                    whether_analyzed: json.whether_analyzed,
    ...
    Generate_Motion = () => {
        ...
        runCsmipGenerateMotion(this.state)
            .then(json => {
                console.log(json);
                this.setState({
